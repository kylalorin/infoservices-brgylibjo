...
@Component({
  ...
  template: `
    <div class="container mx-auto p-8">
      <div class=" p-6">
        <h2 class="text-2xl font-semibold mb-4">Quick Menu</h2>

        <ul class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
          <ng-template [ngxPermissionsOnly]="['ROLE_OFFICIAL']">
            <li
              class="bg-blue-500 hover:bg-blue-600 text-white py-4 px-6 rounded-md cursor-pointer flex items-center justify-center"
            >
              <svg
              ...
              <span class="text-md">Manage Announcement</span>
            </li>
          </ng-template>
          <ng-template [ngxPermissionsOnly]="['ROLE_OFFICIAL']">
            <li
            ...
            >
              ...
              <span class="text-lg">Manage E-Services</span>
            </li>
          </ng-template>
          <ng-template [ngxPermissionsOnly]="['ROLE_OFFICIAL']">
            <li
            ...
            >
              ...
              <span class="text-lg">Generate Forms</span>
            </li>
          </ng-template>
          <ng-template [ngxPermissionsOnly]="['ROLE_OFFICIAL']">
            <li
            ...
            >
              ...
              <span class="text-lg">Manage Poll</span>
            </li>
          </ng-template>
          <ng-template [ngxPermissionsOnly]="['ROLE_OFFICIAL']">
            <li
            ...
            >
              ...
              <span class="text-lg">Manage Post</span>
            </li>
          </ng-template>
          <ng-template [ngxPermissionsOnly]="['ROLE_ADMIN']">
            <li
              class="bg-blue-500 hover:bg-blue-600 text-white py-4 px-6 rounded-md cursor-pointer flex items-center justify-center"
            >
              <svg
          ...
          <ng-template [ngxPermissionsOnly]="['ROLE_ADMIN']">
            ...
            >
              ...
              <span class="text-lg">Create User</span>
            </li>
          </ng-template>
          <ng-template [ngxPermissionsOnly]="['ROLE_ADMIN']">
            <li
            ...
            >
              ...
              <span class="text-lg">Issuance Request</span>
            </li>
          </ng-template>
          <ng-template [ngxPermissionsOnly]="['ROLE_ADMIN']">
            <li>
              <a
                [routerLink]="['/admin/verification-request']"
                class="bg-blue-500 hover:bg-blue-600 text-white py-4 px-6 rounded-md cursor-pointer flex items-center justify-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="text-lg">Verification Request</span>
              </a>
            </li>
          </ng-template>
          <ng-template [ngxPermissionsOnly]="['ROLE_ADMIN']">
            ...
            >
              ...
              <span class="text-lg">Manage Database</span>
            </li>
          </ng-template>
        </ul>
      </div>
